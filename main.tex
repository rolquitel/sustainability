...
\begin{figure}
	\begin{center}
		\includegraphics[width=1.0\textwidth]{fig_01.pdf}
	\end{center}
...
%\KwData{$n \geq 0$}
\KwIn{ \\
    $MF_{B} = \{ mf_{1}, mf_{2}, ..., mf_{n} \}$, set of medical facilities inside buffer R. \\
    $s_{u}$, required speciality by the user. \\
